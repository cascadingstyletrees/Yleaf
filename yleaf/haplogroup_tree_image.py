...
def main(namespace: argparse.Namespace = None):
    ...
    if namespace.collapse_mode:
        ...
        edge_mapping = {}
    make_dendrogram(
        partial_haplogroup_dict, sample_mapping, edge_mapping, namespace.outfile
    )
...
def get_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "-c",
        "--collapse_mode",
        help="Add this flag to compress the haplogroup tree image and remove"
...
def read_input_file(file: str) -> tuple[list[str], dict[str, list[str]]]:
    haplogroups = []
...
def collapse_tree_dict(
    partial_tree_dict: dict[str, set[str]], sample_mapping: dict[str, list[str]]
